...
import { useTopCustomersReport } from "@/features/reports/hooks";
...
export function CustomersReportPage() {
  ...
  const { data: topCustomers } = useTopCustomersReport({ ...rangeParams, limit: 30 });

  return (
    <div className="space-y-4">
      <PageHeader title="Báo cáo khách hàng" description="Khách hàng mua nhiều nhất theo thời gian" />
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b text-left text-muted-foreground">
                  <th className="py-1.5 font-medium">Khách hàng</th>
