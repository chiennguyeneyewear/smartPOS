...
export const MENU_ITEM_LABELS: Record<MenuKey, string> = {
  ...
  [MENU_ITEMS.PREORDERS]: "Đặt hàng",
  [MENU_ITEMS.TASKS]: "Quản lý công việc",
...
export const DEFAULT_MENU_ACCESS: Record<RoleName, MenuKey[]> = {
  ...
  [ROLES.MANAGER]: [
    ...
    MENU_ITEMS.PREORDERS,
    MENU_ITEMS.TASKS,
    MENU_ITEMS.REPORTS,
  ],
  [ROLES.CASHIER]: [MENU_ITEMS.POS, MENU_ITEMS.PRODUCTS, MENU_ITEMS.CUSTOMERS, MENU_ITEMS.PREORDERS, MENU_ITEMS.TASKS],
  [ROLES.WAREHOUSE]: [MENU_ITEMS.PRODUCTS, MENU_ITEMS.TASKS],
};
